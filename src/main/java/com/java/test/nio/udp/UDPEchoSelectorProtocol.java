...
import com.java.test.nio.Server;
...
public class UDPEchoSelectorProtocol implements EchoProtocol {
    ...
    public void handleRead(SelectionKey key) throws IOException {
        ...
        System.out.println("android123 receive info:" + Server.decode(clntRec.buffer));
    ...
    public void handleWrite(SelectionKey key) throws IOException {
        ...
        System.out.println("android123 send info:" + new String(clntRec.buffer.array()));
